...
import { A as picocolorsExports, B as bindShortcuts, w as createLogger, h as resolveConfig } from './chunks/dep-c737681a.js';
...
cli
    ...
    // is ok here
    const { createServer } = await import('./chunks/dep-c737681a.js').then(function (n) { return n.F; });
    try {
...
cli
    ...
    .action(async (root, options) => {
    filterDuplicateOptions(options);
    const { build } = await import('./chunks/dep-c737681a.js').then(function (n) { return n.E; });
...
cli
    ...
    .action(async (root, options) => {
    filterDuplicateOptions(options);
    const { optimizeDeps } = await import('./chunks/dep-c737681a.js').then(function (n) { return n.D; });
    try {
...
cli
    ...
    .action(async (root, options) => {
    filterDuplicateOptions(options);
    const { preview } = await import('./chunks/dep-c737681a.js').then(function (n) { return n.G; });
    try {
